defmodule ChatListItem do
  ...
  def render(assigns) do
    ~H"""
    <div class="mx-auto">
      <div class="h-screen min-w-full border rounded lg:grid lg:grid-cols-3">
        <div class="border-r border-gray-300 lg:col-span-1">
          ...
          <ul class="overflow-auto">
            ...
            <div class="relative w-full overflow-y-auto h-[70rem]">
            <li>
              <a
        ...
        <div class="hidden lg:col-span-2 lg:block">
          <div class="w-full">
            ...
            <div class="relative w-full p-6 overflow-y-auto h-[70rem]">
              <ul class="space-y-2">
